          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                this.rendered = false;
                _context2.next = 6;
                return axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/api/taxonomy/".concat(this.type, "?as_tree=1"));
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                this.loading = true;
                _context4.next = 6;
                return axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/api/items?".concat(this.type, "[]=").concat(this.selected));
