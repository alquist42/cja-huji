(function() {
  ...
  function __ANIMATE_SCROLL_TO(desiredOffset) {
    ...
    if (options.cancelOnUserAction) {
      // Item handler to cancel scroll on user action
      ...
      // Item handler to prevent user actions while scroll is active
    ...
    var step = function () {
      ...
      if (timeDiff < duration && scrollPosition !== desiredOffset) {
        ...
        // Item scroll to the desired offset (when rounding made it to be off a pixel or two)
