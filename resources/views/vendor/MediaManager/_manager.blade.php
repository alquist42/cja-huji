...
<media-manager inline-template
    ...
    :routes="{{ json_encode([
        ...
        'locked_list' => route('staff.media.locked_list')
    ]) }}"
                                        ...
                                        <table>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="t-val">
                                                        <form action="{{ route('staff.media.folder_download') }}"method="post" @submit.prevent="ZipDownload($event)">
                                                            {{ csrf_field() }}
                                        ...
                                        <table>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    {{-- zip --}}
                                                    <td class="t-val">
                                                        <form action="{{ route('staff.media.files_download') }}"
                                                            method="post"
