...
@section('main-content')
    <div class="row">
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">66 New Icons In 4.4</h4>
                    <div class="row">
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">Web Application Icons</h4>
                    <div class="row">
                        <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">Hand Icons</h4>
                    <div class="row">
                        <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
                                    class="fa fa-hand-grab-o"></i>
                                hand-grab-o <span class="text-muted">(alias)</span></a></div>
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">Transportation Icons</h4>
                    <div class="row">
                        <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">Gender Icons</h4>
                    <div class="row">
                        <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
                                    class="fa fa-genderless"></i>
                                genderless</a></div>
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">File Type Icons</h4>
                    <div class="row">
                        <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">Spinner Icons</h4>
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">Form Control Icons</h4>
                    <div class="row">
                        <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
                                    class="fa fa-check-square"></i>
                                check-square</a></div>
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">Payment Icons</h4>
                    <div class="row">
                        <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">Chart Icons</h4>
                    <div class="row">
                        <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
                                    class="fa fa-area-chart"></i>
                                area-chart</a></div>
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">Currency Icons</h4>
                    <div class="row">
                        <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">Text Editor Icons</h4>
                    <div class="row">
                        <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">Directional Icons</h4>
                    <div class="row">
                        <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">Video Player Icons</h4>
                    <div class="row">
                        <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
                                    class="fa fa-arrows-alt"></i>
                                arrows-alt</a></div>
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">Brand Icons</h4>
                    <div class="row">
                        <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
                                    class="fa fa-500px"></i> 500px</a></div>
                        <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card_title">Medical Icons</h4>
                    <div class="row">
                        <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
                                    class="fa fa-ambulance"></i> ambulance</a></div>
                        <div class="fw-icons col-lg-3 col-sm-6"><a href="#"><i
